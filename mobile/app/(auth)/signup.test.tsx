...
describe('Signup', () => {
  ...
  it('signs in and navigates to home when the form is valid', async () => {
    ...
    await fireEvent.changeText(screen.getByPlaceholderText('Maria Silva'), 'Maria Silva');
    await fireEvent.changeText(screen.getByPlaceholderText('maria@email.com'), 'maria@email.com');
    await fireEvent.changeText(screen.getByPlaceholderText('Crie uma senha'), 'secret123');
