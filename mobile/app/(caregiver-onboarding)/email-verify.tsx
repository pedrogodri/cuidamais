...
export default function EmailVerify() {
  ...
  const email = useCaregiverVerificationStore((state) => state.email);
  const setEmailVerified = useCaregiverVerificationStore((state) => state.setEmailVerified);
  ...
  function handleConfirm() {
    ...
    router.push('/(caregiver-onboarding)/facial-intro');
  }
